...
csv_folder = Path("scores/Meta-Llama-3-8B-Instruct/SetFit/subj/n56_target_description_and_classes_1")
...
plt.title(f"InSPEcT SUBJ ROUGE1 Smoothness by Src / Tgt Layer (Mean of {len(all_dfs)} files)")
