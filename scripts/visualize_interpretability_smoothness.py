...
csv_folder = Path("cot_scores/Meta-Llama-3-8B-Instruct/SetFit/sst5/n56_target_description_and_classes_1")
...
plt.title(f"SST5 56 Tokens - ROUGE1 Smoothness by Src / Tgt Layer (Mean of {len(all_dfs)} inference runs)")
