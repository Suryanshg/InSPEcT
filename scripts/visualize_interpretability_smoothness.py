...
csv_folder = Path("cot_scores/Meta-Llama-3-8B-Instruct/SetFit/subj/n28_target_description_and_classes_1")
...
plt.title(f"Subj 28 Tokens - ROUGE1 Smoothness by Src / Tgt Layer (Mean of {len(all_dfs)} inference runs)")
